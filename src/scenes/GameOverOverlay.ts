...
export class GameOverOverlay extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(this.gameScene.view.width / 2, this.gameScene.view.height / 2 - 25, 'You reached dungeonfloor ' + this.gameScene.floorData.floor, { color: '#FBB954' }).setOrigin(0.5, 0.5).setScale(2);
